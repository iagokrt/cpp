...
/**
    ...
    linear/angular passadas estejam fora do limite de velocidade do robô. O programa deve
    apresentar as velocidades das rodas na tela, com as seguintes mensagens: “Velocidade
    da roda esquerda = ” e “Velocidade da roda direita = ”. Após apresentar as velocidades
    das rodas, o programa deve esperar 1 segundo (use a biblioteca “chrono” e “thread” do
    C++) e pedir novamente as velocidades linear e angular. O programa irá encerrar apenas
    quando forçado na IDE.
...
void velocity(int &v, int &w, int largura) {
    //int v1 = v +     
}
